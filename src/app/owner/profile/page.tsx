    ...
    return (
      <div className="p-6">
        <div className="container mx-auto max-w-2xl space-y-6">
          ...
          <Skeleton className="h-96 rounded-[28px] bg-white/10" />
        </div>
      </div>
    );
  }
    ...
    <div className="pb-24 pt-8 text-white">
      <div className="container mx-auto max-w-3xl px-4">
        <motion.div
          ...
          className="role-panel-dark-strong mb-8 p-6 sm:p-8"
        >
          <div className="role-pill-dark mb-4">
            <IconSettings className="h-4 w-4 text-orange-300" />
            Brand profile
          </div>
          ...
          <p className="mt-2 text-white/60">Refine how your truck looks across discovery, menus, and search results.</p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <Card className="role-panel-dark overflow-hidden">
            {/* Cover Image */}
            <div
              className="group relative h-48 cursor-pointer bg-black/20"
            ...
            >
              {profile?.imageUrl ? (
                ...
                <div className="flex h-full w-full flex-col items-center justify-center text-white/35">
            ...
            <div className="relative px-6 pb-6">
              <div
                className="group absolute -top-12 left-6 h-24 w-24 cursor-pointer overflow-hidden rounded-[24px] border-4 border-[#120f0c] bg-black/30 shadow-xl"
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="role-input-dark min-h-[100px]"
                />
              </div>
              ...
              <Button
                onClick={handleSave}
                disabled={saving}
                className="w-full rounded-full bg-gradient-to-r from-orange-500 to-amber-400 font-semibold text-slate-950 hover:from-orange-400 hover:to-amber-300"
              >
                {saving ? (

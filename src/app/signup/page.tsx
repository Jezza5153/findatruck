...
export default function OwnerSignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // 1.a Force-refresh the ID token directly on the returned user object
      //     This ensures Firestore sees the authentication state immediately.
      ...
      if (newUser) {
        // Another token refresh directly on newUser just before writing the truck doc
        await newUser.getIdToken(true);

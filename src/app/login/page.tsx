    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-8rem)] py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background to-secondary/10">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Log in to find your favorite food trucks.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link href="/reset-password" passHref className="text-sm font-medium text-primary hover:underline">
          ...
          <div>
            ...
            <Button variant="outline" className="w-full mb-2">
              {/* Google Icon SVG or Lucide */}
              Sign in with Google
            </Button>
            <Button variant="outline" className="w-full">
              {/* Facebook Icon SVG or Lucide */}
